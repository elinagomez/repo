...
# library(htmlwidgets)
# library(widgetframe)
# htmlwidgets::saveWidget(a,file="C:/Users/Usuario/Desktop/2023-02-21-gpt3-ccss/a.html",selfcontained = TRUE)
...
DT::datatable(a,rownames = TRUE, options = list(pageLength = 50,dom = 'Bfrtip',
scrollX = T,columnDefs = list(list(targets = c(1,2),render = DT::JS(
                                                                                          "function(data, type, row, meta) {",
                                                                                                 "return type === 'display' && data.length > 40 ?",
                                                                                                 "'<span title=\"' + data + '\">' + data.substr(0, 40) + '...</span>' : data;","}")))), callback = JS('table.page(3).draw(false);'))
