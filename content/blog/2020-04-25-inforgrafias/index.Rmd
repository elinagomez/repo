...
serie_linea=read.csv("Inforgrafia/serie_linea.csv",sep = ";")
...
serie_barra=read.csv("Inforgrafia/serie_barra.csv",sep=";")
...
depto=read.csv("Inforgrafia/depto.csv",sep=";")
uru = st_read("Inforgrafia/ine_depto.shp", crs = 32721, stringsAsFactors = F,quiet = TRUE)
coord = st_read("Inforgrafia/dptos_centroides.shp", crs = 32721,quiet = TRUE)
...
piramide=read.csv2("Inforgrafia/piramide_edad.csv")
...
datos=read.csv2(paste0("Inforgrafia/datos.csv"))

#cargo íconos  
icon1=readPNG("Inforgrafia/icon1.png")
icon2=readPNG("Inforgrafia/icon2.png")
icon3=readPNG("Inforgrafia/icon3.png")
icon4=readPNG("Inforgrafia/icon4.png")

#cargo logo 
logo=readPNG("Inforgrafia/rlogo.png")
...
pdf(paste0("C:/Users/Usuario/Documents/repo/content/blog/2020-04-25-inforgrafias/",nombre,".pdf"), width = 40, height = 22)
...
![](C:/Users/Usuario/Documents/repo/content/blog/2020-04-25-inforgrafias/Inforgrafia.jpg)
